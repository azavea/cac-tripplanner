    ...
    return [
        {
            ...
            'description': 'The mission of the Fairmount Water Works (FWW)  is to foster stewardship of our shared water resources by encouraging informed decisions about the use of land and water. We educate citizens about Philadelphia’s urban watershed – its past, present and future – and collaborate with partners to instill an appreciation for the connections between daily life and the natural environment.',
        ...
        },
        {
            ...
            'description': 'Explore Philadelphia\'s only maritime museum! See nautical art, interactive exhibits, the Workshop on the Water, and our two historic ships - the cruiser Olympia, the oldest steel warship still afloat in the world and the WWII-era submarine Becuna - all included in Museum admission.',
        ...
        },
        {
            ...
            'description': 'The Schuylkill Center inspires meaningful connections between people and nature. We use our forests and fields as a living laboratory to foster appreciation, deepen understanding, and encourage stewardship of the environment.',
        ...
        },
        {
            ...
            'description': 'The mission of the Center for Aquatic Sciences at Adventure Aquarium is Education and Youth Development through promoting the understanding, appreciation, and protection of aquatic life and habitats. The nonprofit Center for Aquatic Sciences at Adventure Aquarium (CAS) is a leader in conservation-oriented research, environmental education, and community service both locally and globally.',
        ...
        },
        {
            ...
            'description': 'Palmyra Cove Nature Park (PCNP) is a 250 acre urban oasis along a highly developed area on the Delaware River. Habitats included in PCNP are wetlands, woodlands, meadows, wild creek and river shoreline, and freshwater Tidal Cove. By protecting this habitat, PCNP preserves the ecological richness of the local environment.',
            'address': '1335 NJ-73',
            'city': 'Palmyra',
            'state': 'NJ',
            'zip': '08065',
